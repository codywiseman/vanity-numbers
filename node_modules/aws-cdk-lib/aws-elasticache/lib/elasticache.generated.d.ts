 ...
 */
export declare class CfnServerlessCache extends cdk.CfnResource implements cdk.IInspectable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    readonly attrEndpointPort: number;
    /**
     ...
     * @cloudformationAttribute ReaderEndpoint.Port
     */
    readonly attrReaderEndpointPort: number;
    /**
